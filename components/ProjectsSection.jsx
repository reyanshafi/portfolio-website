...
const projects = [
  {
    id: 1,
    title: 'Zaimaqsad',
    description: 'Comprehensive student guidance platform offering scholarships, mentorship, and collaborative support for academic success.',
    image: '/assets/zaimaqsad.jpg', // You'll need to add this image
    tech: ['Next.js', 'MongoDB', 'Node.js'],
    link: 'https://zaimaqsad.vercel.app/',
  ...
  },
  {
    id: 3,
    title: 'MedicareApp',
    description: 'AI-based hospital monitoring system ',
    image: '/assets/medicare.jpg',
    tech: ['React', 'Express', 'Node.js'],
    link: 'https://caremediapp.vercel.app/',
